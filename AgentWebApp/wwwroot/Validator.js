...
! function () {
    ...
    {
        const t = document.getElementById("UserForm"),
            ...
            r = FormValidation.formValidation(t, {
                fields: {
                    ...
                    formValidationConfirmPass: {
                        validators: {
                            ...
                            identical: {
                                compare: function () {
                                    return t.querySelector('[name="formValidationPass"]')
                                        .value
                                },
                ...
                init: e => {
                    e.on("plugins.message.placed", function (e) {
                        e.element.parentElement.classList.contains("input-group") && e.element.parentElement.insertAdjacentElement("afterend", e.messageElement), e.element.parentElement.parentElement.classList.contains("custom-option") && e.element.closest(".row")
